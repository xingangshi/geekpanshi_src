...
### 免费的编程书籍（[原文](https://github.com/sdmg15/free-programming-books/blob/master/free-programming-books.md)）
---
> 这个列表最初是 Clone 由 George Stocker 在 stackoverflow 上的一个提问 《免费书籍列表》，现在更新了一些死链接和添加新内容。现在把这个项目迁移到 GitHub 进行协作更新。
---
...
* [Sage for Power Users](https://wxtein.org/books/sagebook/sagebook.pdf) - William Stein (PDF)
