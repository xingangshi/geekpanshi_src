...
##### ◇ Trello
> Trello 项目管理软件，为你提供遍及你所有项目、工作和家庭场景的视角。无论是管理一个团队、编写一篇史诗级剧本抑或仅是做一张购买清单，Trello 是你整理并维持一切事务井然有序的好帮手。

##### ◇ MeisterTask
> MeisterTask，为个人和团队提供简单有趣的任务管理 (MeisterTask: Task Management)。MeisterTask是在移动设备和浏览器中运行的，最直观的项目和任务管理工具！

##### ◇ LastPass
> LastPass - 免费密码管理器。LastPass 是一款屡获殊荣的密码管理器，为全世界几百万人简化了他们的数字生活。今天就开始试用吧 —— 您会惊叹自己在没有密码管理器之前究竟是怎么支撑下来的！

##### ◇ Day One Journal
> Day One Journal 是一个非常出色的日记应用，以简洁优雅的日志记录体验而闻名。

##### ◇ 记帐助手
> 记帐助手: 个人理财，预算，收支管理。这是一个记帐簿 / 记帐本 / 记帐软体，专为中文用户而设的收支管理工具。

##### ◇ Canva
> Canva - 免费照片编辑器及平面设计工具。Canva 让设计变得极为简单（而且有趣）！即使你不是设计大师，也能用照片和视频创建出精美的设计！

##### ◇ CWMoney
> 記帳CWMoney 管理預算、掃描記帳、理財分析。可惜没有简体中文版。

##### ◇ TimeTree
> 协同日程管理: TimeTree 家人、情侣等等一同管理日程。“只要与家人、恋人、朋友、同事、重要的人们共享时间，就会有美好的未来在等着你。”

##### ◇ Lark Player
> Lark Player —— 音乐和免费视频的播放器，最赞的功能之一：可以直接把视频当做音频播放。
...
##### ◇ 坚果云
> 坚果云，国内最安全、稳定的云存储服务，可以自动下载文件到手机或者平板上，也可以自动备份手机照片到云端，随时随地访问您的数据。

##### ◇ Grid Diary
> Grid Diary —— 每日回顾&反思日记 —— IOS。
